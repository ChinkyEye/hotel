...
use App\Exports\Counter\CustomerReportExport;
use Maatwebsite\Excel\Facades\Excel;

class CustomerDetailController extends Controller
{
  public function index(Request $request){
      $posts = Order_detail::orderBy('id','DESC')->where('is_confirmed','1')->where('created_by',Auth::user()->id)->where('customer_id',$request->user_id);
