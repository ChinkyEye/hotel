...
class OverallReportExport implements FromCollection, WithHeadings
{
    ...
    */
    ...
    public function __construct($receive_type,$bill_type, $start_date, $end_date)
	{
    ...
    {
	     $orders = Order_detail::orderBy('id','DESC')->where('is_confirmed','1')->where('created_by',Auth::user()->id);
