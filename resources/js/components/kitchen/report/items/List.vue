...
<script>
  ...
  export default{
    ...
    itemReportExport(){
      location.href = '/kitchen/report/items/export?category_id='+this.category_id+'&item_id='+this.item_id+'&start_date='+moment(this.date.start).format('YYYY-MM-DD')+'&end_date='+moment(this.date.end).format('YYYY-MM-DD');
    }
    }
  }
</script>
