                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <label for="three" class="mr-md-4 mr-sm-3">Bar</label>
...
<script>
    ...
    created(){
          axios.get(`/manager/item/${this.$route.params.itemid}/edit`)
            .then((response)=>{
      ...
      fetchPosts() {
        ...
        this.$store.dispatch("allUnitSelect")
         ...
         addNewItem(){
          ...
          this.form.put(`/manager/item/${this.$route.params.itemid}`)
          .then((response)=>{
