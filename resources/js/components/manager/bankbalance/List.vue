  ...
  <div>
    <div class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
           <p class="text-danger m-0">Bank Balance</p>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="card">
              <div class="card-header">
                <div class="row">
                  <div class="col-md-2">
                    <router-link to="/bankbalance/create" class="btn btn-flat btn-danger btn-block" style="color:#fff"> Add <i class="fas fa-plus fa-fw"></i></i></router-link>
                  </div>
                  <div class="col-md-10">
      ...
      deleteBankBalance(id){
        ...
        Swal.fire({
          ...
          if(isConfirm.value === true) {
            ...
            Toast.fire({
              icon: 'error',
              title: 'Bank Balance not Deleted'
            })
          }
        })
      },
