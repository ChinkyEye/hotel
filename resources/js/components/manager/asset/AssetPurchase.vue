              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-3 border-right">
                    <form role="form" enctype="multipart/form-data" @submit.prevent="addNewAsset()">
                      <div class="form-group">
                        <input type="hidden" class="form-control" id="price" placeholder="Add Price" v-model="form.assetid" name="assetid">
                      ...
                      <!-- /.card-body -->
                      <button type="submit" class="btn btn-primary btn-block" :disabled="state.isSending">{{state.isSending ? "Loading..." : "Add Asset"}}</button>
                    </form>
                  </div>
                  <div class="col-md-9">
                    <form role="form" class="form-inline">
                      <div class="row">
                        ...
                        <div class="form-group col-4 mb-1">
                          <input type="text" class="form-control w-100" @keyup="searchAsset" v-model="search" placeholder="Search by name">
                        </div>
                    ...
                    <div class="table-responsive">
                      <table class="table table-sm table-bordered table-hover">
                        ...
                        <tbody class="text-center">
                          <tr v-for="(stock,index) in getAllAsset" :key="stock.id">
                            <td>{{index+1}}</td>
                            ...
                            <td>
                              ...
                              | 
                              <a href="" @click.prevent="deleteAsset(stock.id)"><i class="fas fa-trash-alt" title="Click to delete"></i></a>
                            </td>
                          </tr>
                        </tbody>
                      </table>
...
<script>
  ...
  export default{
    ...
    methods:{
      fetchPosts() {
        this.$store.dispatch("allAsset",[this.pagination.current_page, this.search, this.category_idSearch,this.$route.params.assetid,this.type,this.date.toISOString().split('T')[0]]);
