  ...
  <div>
    <div class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <p class="text-danger m-0">Bill List</p>
          </div><!-- /.col -->
          <div class="col-sm-6">
                ...
                <div class="row">
                  <div class="col-md-3 border-right">
                    <form role="form" enctype="multipart/form-data" @submit.prevent="addNewStock()">
                      ...
                      <div class="form-group">
                        <label for="billid">Bill Id <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="billid" placeholder="Add billid" v-model="form.billid" name="billid" :class="{ 'is-invalid': form.errors.has('billid') }" autocomplete="off">
                        <has-error :form="form" field="billid"></has-error>
                      </div>
                      <div class="form-group">
                        <label for="billid">Date <span class="text-danger">*</span></label>
                      ...
                      <!-- /.card-body -->
                      <button type="submit" class="btn btn-primary btn-block" :disabled="state.isSending">{{state.isSending ? "Loading..." : "Add Bill ID"}}</button>
                    </form>
                  </div>
                  <!-- <div class="col-md-9">
...
<script>
  ...
  export default{
    ...
    addNewStock(){
          ...
          this.form.post('/manager/vendorasset')
          .then((response)=>{
