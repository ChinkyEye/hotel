  ...
  <div>
    <div class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Add Kitchen</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                ...
                <div class="card card-primary">
                  ...
                  <form role="form" enctype="multipart/form-data" @submit.prevent="addNewKitchen()">
                    ...
                    <div class="card-footer">
                      <button type="submit" class="btn btn-primary" :disabled="state.isSending">{{state.isSending ? "Loading..." : "Create Kitchen"}}</button>
                    </div>
                  </form>
                </div>
              </div>
...
<script>
    ...
    methods:{
         addNewKitchen(){
          ...
          this.form.post('/manager/kitchen')
          .then((response)=>{
