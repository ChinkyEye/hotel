  ...
  <div>
    <div class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edit Kitchen</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="row">
              <div class="col-8">
                <div class="card card-primary">
                  ...
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form role="form" enctype="multipart/form-data" @submit.prevent="addNewKitchen()">
                    <div class="card-body">
                      <div class="row">
                    ...
                    <div class="card-footer">
                      <button type="submit" class="btn btn-primary" :disabled="state.isSending">{{state.isSending ? "Loading..." : "Update Kitchen"}}</button>
                    </div>
                  </form>
                </div>
              </div>
...
<script>
    ...
    created(){
          axios.get(`/manager/kitchen/${this.$route.params.kitchenid}/edit`)
            .then((response)=>{
              this.form.fill(response.data.kitchens)
            })
        },
    computed:{
        getAllManagertype(){
    ...
    methods:{
         addNewKitchen(){
          ...
          this.form.put(`/manager/kitchen/${this.$route.params.kitchenid}`)
          .then((response)=>{
