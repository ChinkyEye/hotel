          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="card">
              <div class="card-header">
                <div class="row">
                  <div class="col-md-2">
                    <router-link to="/salary/create" class="btn btn-primary btn-block" style="color:#fff"> Add Salary <i class="fas fa-plus fa-fw"></i></i></router-link>
                  </div>
                  <div class="col-md-5">
...
<script>
  import pagination from '../../../components/PaginationComponent.vue';
      ...
      deleteSalary(id){
        ...
        Swal.fire({
            ...
            if(isConfirm.value === true) {
                axios.delete('/manager/salary/'+id)
                .then((response)=>{
                    Toast.fire({
                      icon: 'success',
    ...
    userShow(clkid, show){
        axios.get('/manager/salary/status/'+clkid+'/'+show)
        .then(()=>{
