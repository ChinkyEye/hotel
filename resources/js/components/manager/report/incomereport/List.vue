                ...
                <div class="table-responsive">
                  <div id="printMe">
                    <table class="table table-sm table-bordered table-hover">
                      ...
                      <tbody>
                        <tr v-for="(order,index) in getAllIncomeReport" :key="order.id">
                          <td>{{index+1}}</td>
...
<script>
  ...
  export default{
    ...
    computed:{
      getAllIncomeReport(){
        this.$Progress.start()
        var bvar = this.$store.getters.getIncomeReport;
        this.total = bvar[2];
        // console.log(bvar[2]);
    ...
    pagechange(){
      this.$store.dispatch("allIncomeReport", [this.pagination.current_page,moment(this.date.start).format('YYYY-MM-DD'),moment(this.date.end).format('YYYY-MM-DD')]);
    },
    categoryChange(){
      this.pagechange();
    },
    ...
    incomeReportExport(){
      // location.href = '/manager/report/incomereport/export';
      location.href = '/manager/report/incomereport/export?&start_date='+moment(this.date.start).format('YYYY-MM-DD')+'&end_date='+moment(this.date.end).format('YYYY-MM-DD');
    }
    }
  }
</script>
