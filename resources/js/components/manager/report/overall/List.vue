...
<script>
  ...
  export default{
    ...
    methods:{
      ...
      overallReportExport(){
        location.href = '/manager/report/overall/export?receive_type='+this.receive_type+'&bill_type='+this.bill_type+'&start_date='+moment(this.date.start).format('YYYY-MM-DD')+'&end_date='+moment(this.date.end).format('YYYY-MM-DD');
      }
    }
  }
</script>
