      ...
      <div class="col-8">
        ...
        <form role="form" enctype="multipart/form-data" @submit.prevent="addNewUser()">
            ...
            <!-- <div class="form-group">
                ...
                <select class="form-control" id="user_type_id" v-model="form.user_type" name="user_type_id" :class="{ 'is-invalid': form.errors.has('user_type') }"> 
                ...
                <input type="hidden" class="form-control" id="user_type_id" placeholder="Add New Name" v-model="form.user_type" name="user_type_id" :class="{ 'is-invalid': form.errors.has('name') }">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="phone" placeholder="Add New Phone" v-model="form.phone" name="phone" :class="{ 'is-invalid': form.errors.has('phone') }" autocomplete="off">
                <has-error :form="form" field="phone"></has-error>
            </div>
            <div class="form-group">
                <label for="address">Address</label>
                <input type="text" class="form-control" id="address" placeholder="Add New Address" v-model="form.address" name="address" :class="{ 'is-invalid': form.errors.has('address') }" autocomplete="off">
...
<script>
        ...
        data(){
            return {
              form: new Form({
                name:'',
                // email:'',
                user_type:this.$route.params.userid,
                phone:'',
                address:'',
                date_of_join:'',
            }),
    ...
    methods:{
         addNewUser(){
          ...
          this.form.post(`/manager/customer`)
          .then((response)=>{
