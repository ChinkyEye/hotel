      ...
      <div class="col-8">
        ...
        <form role="form" enctype="multipart/form-data" @submit.prevent="addNewUser()">
            ...
            <div class="form-group">
                <label for="user_type_id">Customer Category <span class="text-danger">*</span></label>
...
<script>
    ...
    created(){
          axios.get(`/manager/customer/${this.$route.params.userid}/edit`)
            .then((response)=>{
    ...
    methods:{
         addNewUser(){
          ...
          this.form.put(`/manager/customer/${this.$route.params.userid}`)
          .then((response)=>{
