      ...
      <div class="col-8">
        ...
        <form role="form" enctype="multipart/form-data" @submit.prevent="addNewCategory()">
            ...
            <div class="form-group">
                ...
                <input type="radio" id="one" value="One" name="type_id" v-model="form.type_id">
                  <label for="one">One</label>
                  <input type="radio" id="two" value="Two" name="type_id" v-model="form.type_id">
...
<script>
    ...
    created(){
          axios.get(`/manager/category/${this.$route.params.categoryid}/edit`)
            .then((response)=>{
    ...
    methods:{
         addNewCategory(){
          ...
          this.form.put(`/manager/category/${this.$route.params.categoryid}`)
          .then((response)=>{
