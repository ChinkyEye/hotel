  ...
  <div>
    <div class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edit Waiter</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="row">
              <div class="col-8">
                <div class="card card-primary">
                  ...
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form role="form" enctype="multipart/form-data" @submit.prevent="addNewWaiter()">
                    <div class="card-body">
                      <div class="row">
                    ...
                    <div class="card-footer">
                      <button type="submit" class="btn btn-primary" :disabled="state.isSending">{{state.isSending ? "Loading..." : "Update Waiter"}}</button>
                    </div>
                  </form>
                </div>
              </div>
...
<script>
    ...
    created(){
          axios.get(`/manager/waiter/${this.$route.params.waiterid}/edit`)
            .then((response)=>{
              this.form.fill(response.data.waiters)
            })
        },
    computed:{
        getAllManagertype(){
    ...
    methods:{
         addNewWaiter(){
          ...
          this.form.put(`/manager/waiter/${this.$route.params.waiterid}`)
          .then((response)=>{
