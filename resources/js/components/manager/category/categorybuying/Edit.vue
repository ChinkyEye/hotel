              ...
              <div class="col-8">
                <div class="card card-primary">
                  <div class="card-header">
                    <router-link to="/category/buying">
...
<script>
    ...
    created(){
          axios.get(`/manager/category/buying/${this.$route.params.categoryid}/edit`)
            .then((response)=>{
    ...
    methods:{
         addNewCategory(){
          ...
          this.form.put(`/manager/category/buying/${this.$route.params.categoryid}`)
          .then((response)=>{
            this.$router.push('/category/buying')
            Toast.fire({
                icon: 'success',
