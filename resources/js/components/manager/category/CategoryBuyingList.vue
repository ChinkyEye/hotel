          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="card">
              <div class="card-header">
                <div class="row">
                  <div class="col-md-2">
                    <router-link to="/category/buying/create" class="btn btn-flat btn-danger btn-block" style="color:#fff"> Add Category <i class="fas fa-plus fa-fw"></i></i></router-link>
                  </div>
                  <div class="col-md-10">
                  ...
                  <table class="table table-sm table-bordered table-hover">
                    ...
                    <tbody>
                      <tr v-for="(category,index) in getAllCategory" :key="category.id"  :class="customerStatus(category.is_active)">
                        ...
                        <td>
                          <div class="btn-group">
                            <router-link :to="`/category/buying/${category.id}/edit`"><i class="fas fa-pencil-alt" title="Click to edit"></i></router-link> 
                            | 
...
<script>
  import pagination from '../../../components/PaginationComponent.vue';
      ...
      deleteCategory(id){
        ...
        Swal.fire({
            ...
            if(isConfirm.value === true) {
                axios.delete('/manager/category/buying/'+id)
                .then((response)=>{
                    Toast.fire({
                      icon: 'success',
    ...
    userShow(clkid, show){
        axios.get('/manager/category/buying/status/'+clkid+'/'+show)
        .then(()=>{
