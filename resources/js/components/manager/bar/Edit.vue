  ...
  <div>
    <div class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edit Bar</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="row">
              <div class="col-8">
                <div class="card card-primary">
                  ...
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form role="form" enctype="multipart/form-data" @submit.prevent="addNewBar()">
                    <div class="card-body">
                      <div class="row">
                    ...
                    <div class="card-footer">
                      <button type="submit" class="btn btn-primary" :disabled="state.isSending">{{state.isSending ? "Loading..." : "Update Bar"}}</button>
                    </div>
                  </form>
                </div>
              </div>
...
<script>
    ...
    created(){
          axios.get(`/manager/bar/${this.$route.params.barid}/edit`)
            .then((response)=>{
              this.form.fill(response.data.bars)
            })
        },
    computed:{
        getAllManagertype(){
    ...
    methods:{
         addNewBar(){
          ...
          this.form.put(`/manager/bar/${this.$route.params.barid}`)
          .then((response)=>{
