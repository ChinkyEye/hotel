  ...
  <div>
    <div class="content-header">
      <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <p class="text-danger m-0">Order 
                  <span class="text-primary float-right" v-if="status == 0">{{name}} {{check_in_date}} 
                  </span>
                </p> 
            </div><!-- /.col -->
        </div><!-- /.row -->
                ...
                <div class="col-md-3">
                  <form>
                    ...
                    <div class="form-group">
                      ...
                      <v-select id="user_id" name="user_id" :class="{ 'is-invalid': form.errors.has('user_id') }" :options="getAllUserSelect" v-on:input="custChange" v-model="customerSelected" @input="retrieveData(form.user_id)"> 
                      </v-select>
...
<script>
  import moment from 'moment';
    ...
    data(){
      ...
      retrieveData(id){
        axios.get('/counter/order/retrievecustomer/'+id)
          .then((response)=>{
              Toast.fire({
                  icon: 'success',
              ...
              if(response.data.datas){
                ...
                this.status = response.data.datas.is_check_out;
              }
              else{
                this.name= null;
