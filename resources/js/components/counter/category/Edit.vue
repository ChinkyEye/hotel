                ...
                <div class="card card-primary">
                  ...
                  <form role="form" enctype="multipart/form-data" @submit.prevent="addNewCategory()">
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        <label for="nameID" class="mr-4">Type <span class="text-danger">*</span></label>
                        <input type="radio" id="one" value="1" name="type_id" v-model="form.type_id">
                        <label for="one" class="mr-4">Buyer(i buy)</label>
                        <input type="radio" id="two" value="2" name="type_id" v-model="form.type_id">
...
<script>
    ...
    created(){
          axios.get(`/counter/category/${this.$route.params.categoryid}/edit`)
            .then((response)=>{
    ...
    methods:{
         addNewCategory(){
          ...
          this.form.put(`/counter/category/${this.$route.params.categoryid}`)
          .then((response)=>{
