              ...
              <div class="col-8">
                <div class="card card-primary">
                  <div class="card-header">
                    <router-link to="/category/selling">
...
<script>
    ...
    created(){
          axios.get(`/counter/category/selling/${this.$route.params.categoryid}/edit`)
            .then((response)=>{
    ...
    methods:{
         addNewCategory(){
          ...
          this.form.put(`/counter/category/selling/${this.$route.params.categoryid}`)
          .then((response)=>{
            this.$router.push('/category/selling')
            Toast.fire({
                icon: 'success',
