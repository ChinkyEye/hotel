...
<script>
  import pagination from '../../../components/PaginationComponent.vue';
    ...
    addNewItem(){
      ...
      addNewCategory(){
        var that = this;
          ...
          this.form_add.post('/counter/category')
          .then((response)=>{
      ...
      addNewUnit(){
        var that = this;
          ...
          this.form_unit.post('/counter/unit')
          .then((response)=>{
    ...
    categoryChange(){
      ...
      salesReportExport(){
        location.href = '/counter/item/export?search='+this.search+'&category_id='+this.category_idSearch;
      }
		},
