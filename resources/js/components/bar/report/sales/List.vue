...
<script>
  ...
  export default{
    ...
    methods:{
      ...
      salesReportExport(){
        location.href = '/bar/report/sales/export?bill_id='+this.search+'&user_type='+this.user_t_id+'&table_id='+this.table_id+'&bill_type='+this.bill_type+'&start_date='+moment(this.date.start).format('YYYY-MM-DD')+'&end_date='+moment(this.date.end).format('YYYY-MM-DD');
      }
  }
}
</script>
