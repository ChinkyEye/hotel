...
<script>
  import pagination from '../../../components/PaginationComponent.vue';
    ...
    addNewItem(){
      ...
      addNewCategory(){
        var that = this;
          ...
          this.form_add.post('/bar/category')
          .then((response)=>{
      ...
      userShow(clkid, show){
        axios.get('/bar/item/status/'+clkid+'/'+show)
        .then(()=>{
            Toast.fire({
                icon: 'success',
    ...
    categoryChange(){
      ...
      salesReportExport(){
        location.href = '/bar/item/export?search='+this.search+'&category_id='+this.category_idSearch;
      }
		},
