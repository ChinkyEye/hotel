          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="card">
              <div class="card-header">
                <div class="row">
                  <div class="col-md-3">
                    <router-link :to="`/customer/${this.$route.params.userid}/create`"  class="btn btn-primary btn-block" style="color:#fff"> Add {{user_type_name}} <i class="fas fa-plus fa-fw"></i></router-link>
                  </div>
                  <div class="col-md-9">
  ...
  export default{
    ...
    createUser(){
      // console.log(this.form);
        ...
        this.form.post('/home/user/package')
        .then(() => {
    ...
    createUserSalary(){
      this.$Progress.start()
        this.form.post('/home/user/salary')
        .then(() => {
            Fire.$emit('AfterCreatedUserLoadIt'); //custom events
            Toast.fire({
                icon: 'success',
