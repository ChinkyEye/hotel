...
<script>
  ...
  export default{
    ...
    pagechange(){
      this.$store.dispatch("allAssetReport", [this.pagination.current_page,this.buyer_id, this.search, this.category_id,this.manager_id]);
    },
    managerChange(){
      this.pagechange();
    },
    ...
    itemReportExport(){
      location.href = '/home/report/asset/export?buyer_id='+this.buyer_id+'&search='+this.search+'&category_id='+this.category_id;
    }
    }
  }
</script>
