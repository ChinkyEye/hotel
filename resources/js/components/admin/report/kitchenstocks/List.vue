...
<script>
  ...
  export default{
    ...
    pagechange(){
      this.$store.dispatch("allKitchenStockdetail", [this.pagination.current_page, this.search, this.category_id,this.manager_id]);
    },
    managerChange(){
      this.pagechange();
    },
    ...
    itemReportExport(){
      location.href = '/home/report/kitchen-stocks/export?search='+this.search+'&category_id='+this.category_id;
