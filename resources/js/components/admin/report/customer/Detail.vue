            ...
            <form @submit.prevent="createUser()">
                <div class="modal-body">
                  ...
                  <div class="form-group">
                        <label>Amount</label>
                        <input type="text" class="form-control" placeholder="Add New Name" v-model="form.amount" :class="{ 'is-invalid': form.errors.has('amount') }">
                        <has-error :form="form" field="name"></has-error>
                  </div>
                  <div class="form-group">
                        <label>Date</label>
                        <!-- <date-picker v-model="form.date" lang="en" type="date" format="YYYY-MM-dd" :class="{ 'is-invalid': form.errors.has('date') }"></date-picker> -->
                        <date-picker v-model="form.date" v-on:input="dateChange">
...
<script>
  ...
  export default{
    ...
    methods:{
      ...
      createUser(){
        this.$Progress.start()
        this.form.post('/home/report/customer/seller')
        .then(() => {
