                ...
                <div class="card card-primary">
                  ...
                  <form role="form" enctype="multipart/form-data" @submit.prevent="addNewIncomeTopic()">
                    ...
                    <div class="card-footer">
                      <button type="submit" class="btn btn-primary" :disabled="state.isSending">{{state.isSending ? "Loading..." : "Update Topic"}}</button>
                    </div>
                  </form>
                </div>
              </div>
...
<script>
    ...
    created(){
          axios.get(`/home/income/topic/${this.$route.params.incometopicid}/edit`)
            .then((response)=>{
    ...
    methods:{
         addNewIncomeTopic(){
          ...
          this.form.put(`/home/income/topic/${this.$route.params.incometopicid}`)
          .then((response)=>{
