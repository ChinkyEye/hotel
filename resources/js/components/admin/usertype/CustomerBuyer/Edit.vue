                ...
                <div class="card card-primary">
                  ...
                  <form role="form" enctype="multipart/form-data" @submit.prevent="addNewCategory()">
                    ...
                    <div class="card-footer">
                      <button type="submit" class="btn btn-primary" :disabled="state.isSending">{{state.isSending ? "Loading..." : "Update Buyer"}}</button>
                    </div>
                  </form>
                </div>
              </div>
...
<script>
    ...
    created(){
          axios.get(`/home/customer/buyer/${this.$route.params.customerid}/edit`)
            .then((response)=>{
    ...
    methods:{
         addNewCategory(){
          ...
          this.form.put(`/home/customer/buyer/${this.$route.params.customerid}`)
          .then((response)=>{
            this.$router.push('/customer/buyer')
            Toast.fire({
                icon: 'success',
