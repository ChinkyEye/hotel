  ...
  <div>
    <div class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Add Seller</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                ...
                <div class="card card-primary">
                  ...
                  <form role="form" enctype="multipart/form-data" @submit.prevent="addNewCategory()">
                    ...
                    <div class="card-footer">
                      <button type="submit" class="btn btn-primary" :disabled="state.isSending">{{state.isSending ? "Loading..." : "Add Seller"}}</button>
                    </div>
                  </form>
                </div>
              </div>
...
<script>
    ...
    methods:{
         addNewCategory(){
          ...
          this.form.post('/home/customer/seller')
          .then((response)=>{
