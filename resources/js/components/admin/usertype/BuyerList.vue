                    ...
                    <section class="col-lg-12 connectedSortable">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-md-2">
                                        <router-link to="/customer/buyer/create" class="btn btn-flat btn-danger btn-block" style="color:#fff"> Add Buyer <i class="fas fa-plus fa-fw"></i></router-link>
                                    </div>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" @keyup="searchService" v-model="search" placeholder="Search Buyer">
                                    </div>
                                </div>
                            </div><!-- /.card-header -->
                            <div class="card-body">
...
methods:{
    ...
    deleteUser(id){
        ...
        Swal.fire({
            ...
            if(isConfirm.value === true) {
                axios.delete('/home/customer/buyer/'+id)
                .then((response)=>{
    ...
    userShow(clkid, show){
        axios.get('/home/customer/buyer/status/'+clkid+'/'+show)
        .then(()=>{
            this.$store.dispatch("getAllBuyerType", [this.pagination.current_page,0]);
            Toast.fire({
                icon: 'success',
    ...
    userSalary(clkid, show){
        axios.get('/home/customer/buyer/salary/'+clkid+'/'+show)
        .then(()=>{
            this.$store.dispatch("getAllBuyerType", [this.pagination.current_page,0]);
            Toast.fire({
                icon: 'success',
