          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="card">
              <div class="card-header">
                <div class="row">
                  <div class="col-md-2">
                    <router-link to="/salary/create" class="btn btn-primary btn-block" style="color:#fff"> Add Salary <i class="fas fa-plus fa-fw"></i></router-link>
                  </div>
                  <div class="col-md-5">
...
<script>
  import pagination from '../../../components/PaginationComponent.vue';
    ...
    userShow(clkid, show){
        axios.get('/home/salary/status/'+clkid+'/'+show)
        .then(()=>{
