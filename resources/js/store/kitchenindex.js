export default{
	...
	actions:{
		...
		allSellingCategory(context, params){
			axios.get("/kitchen/category/selling?page="+params[0]+"&search="+params[1])
				.then((response)=>{
