...
//configure
import Configure from './components/admin/configure/List.vue'
//report list
import Report from './components/admin/report/List.vue'

import FiscalYear from './components/admin/fiscalyear/List.vue'
import FiscalYearNew from './components/admin/fiscalyear/New.vue'
import FiscalYearEdit from './components/admin/fiscalyear/Edit.vue'

import Setting from './components/admin/setting/List.vue'
import SettingNew from './components/admin/setting/New.vue'
import SettingEdit from './components/admin/setting/Edit.vue'
...
//income report
import IncomeReport from './components/admin/report/incomereport/List.vue'
//expense report
import ExpenseReport from './components/admin/report/expensereport/List.vue'
//room report
import RoomReport from './components/admin/report/roomreport/List.vue'
...
export const routes = [
	...
	},
	{
		...
		component: FiscalYearNew
	},
	{
		path:'/fiscalyear/:fiscalyearid/edit',
