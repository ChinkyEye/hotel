...
<head>
  ...
  <title>Restaurant Management | Bar</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper" id="app">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <router-link :to="{ name: 'confirm' }" class="nav-link"><i class="fas fa-cogs"></i>Token</router-link>
        </li>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <img src="{{ asset('image/logo.png') }}" alt="Techware Logo" class="brand-image elevation-3">
        <span class="brand-text font-weight-light">Bar</span>
      </a>
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; 2021 <a href="https://www.techware.com.np">Techware Pvt Ltd</a>.</strong>
      All rights reserved.
  ...
  <script src="{{ asset('js/barapp.js') }}" defer></script>
