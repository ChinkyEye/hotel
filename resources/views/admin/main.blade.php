  ...
  <div class="wrapper" id="app">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <router-link :to="{ name: 'configure' }" class="nav-link"><i class="fas fa-file"></i>Configure</router-link>
        </li>
        <li class="nav-item">
          <router-link :to="{ name: 'activitylog' }" class="nav-link"><i class="fas fa-file"></i>Activity Log</router-link>
        </li>
        <li class="nav-item">
          <router-link :to="{ name: 'fiscalyear' }" class="nav-link"><i class="fas fa-cogs"></i>Fiscal Year</router-link>
        </li>
        <li class="nav-item">
          <router-link :to="{ name: 'setting' }" class="nav-link"><i class="fas fa-cogs"></i>Setting</router-link>
        </li>
        <li class="nav-item">
